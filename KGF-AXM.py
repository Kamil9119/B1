...
#---------------------------------------------[FILE UPDATE]---------------------------------------------#
arafat1 = '[FBAN/FB4A;FBAV/' + str(random.randint(11,99)) + '.0.0.' + str(random.randint(1111,9999)) + ';FBBV/' + str(random.randint(1111111,9999999)) + ']'
arafat2 = '[FBAN/FB4A;FBAV/' + str(random.randint(11,99)) + '.0.0.' + str(random.randint(1111,9999)) + ';FBBV/' + str(random.randint(1111111,9999999)) + ']'
arafat3 = '[FBAN/FB4A;FBAV/' + str(random.randint(11,99)) + '.0.0.' + str(random.randint(1111,9999)) + ';FBBV/' + str(random.randint(1111111,9999999)) + ']'
arafat4 = '[FBAN/FB4A;FBAV/' + str(random.randint(11,99)) + '.0.0.' + str(random.randint(1111,9999)) + ';FBBV/' + str(random.randint(1111111,9999999)) + ']'
...
#_____________________[MENU BOX]____________________________#
    def ___file__RanD_All__(self):
        ...
        elif ch in ['4','d','D']:os.system('xdg-open https://t.me/KGF_TEAM_CYBER');sleep(4);__Main_all_sys___for__run__().__logo__();animation(f'{z}{G}THANKS FOR YOUR FEEDBACK....!');sleep(2);__Main_all_sys___for__run__().__logo__();animation(f'{z}{G}RESTARTING THE TOOL.......!');sleep(0.5);__Main_all_sys___for__run__().___file__RanD_All__()
